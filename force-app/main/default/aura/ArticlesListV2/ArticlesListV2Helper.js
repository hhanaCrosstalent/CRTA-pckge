({
    getArticles: function (component) {
        ...
        let action = component.get("c.getArticlesList");
                                    console.log('the liim ' + component.get('v.limiter'));
        ...
        if(!!action) {
            ...
            action.setCallback(this, function(r) {
                ...
                if (state == 'SUCCESS') {
                    ...
                    if (component.get("v.listArticles") && component.get("v.listArticles").length>0) {
                    component.set("v.articleId", component.get("v.listArticles")[0].Id);     
